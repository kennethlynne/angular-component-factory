...
describe('Module decorator', function () {
  ...
  beforeEach(function () {
    ...
    testModule.value('$compileProvider', $compileProvider);

    module('testModule');

    inject(function (_$injector_, componentFactory) {
  ...
  it('should register a directive when component is called', function () {
    testModule.component('test', angular.noop);
    expect($compileProvider.directive).toHaveBeenCalled();
  });

  it('should pass the correct parameters to $compileProvider', function() {
    testModule.component('test', angular.noop);
    ...
    expect(factory).toBe(angular.noop);
  });
  ...
  xit('should be chainable', function () {
    function wrapper() {
      testModule.component('test', function () {
        return {}
